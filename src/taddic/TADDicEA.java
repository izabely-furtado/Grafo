...
public class TADDicEA extends TADDicionario {
    ...
    public TADDicEA(HashEngine he) {
        super(he);
        this.vetBulckets = new Item[1000];
    ...
    private void redimensiona() {
        ...
        if (this.tamanho > vetBulckets.length * 0.8) {
            this.N = (int) (N * 1.5);
...
//   }
    ...
    public Object insertItem4(Object chave, Object obj, int hash) {
        int index = hash % this.vetBulckets.length;
        if (this.vetBulckets[index] == null) {
